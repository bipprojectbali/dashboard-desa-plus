...
async function fetchJennaAnalytics(): Promise<JennaAnalyticsData> {
	...
	return (await r.json()) as JennaAnalyticsData;
}

function useJennaAnalytics() {
	const query = useApiQuery(["jenna", "analytics"], fetchJennaAnalytics, {
		autoRefresh: true,
	});
